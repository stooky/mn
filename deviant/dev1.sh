...
echo "Deviant Setup and Installation Script"
echo "#"
echo "#"
echo "#"
echo "#"
...
# Download the source to compile


	echo "#####################################################"
	echo "# FULL SETUP: Downloading the Deviant source files. #"
	echo "#   It takes a while to compile, have patience. You #"
	echo "#  should only have to do this once, and then you   #"
	echo "#  can use the quick install for additional nodes.  #"
	echo "#####################################################"
	echo "."
	echo "."
