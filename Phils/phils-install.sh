...
echo "*                                                                       *"
echo "* This script will install and configure your Phils masternode          *"
echo "*                         v1.1.0                                        *"
echo "*************************************************************************"
echo && echo && echo
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
...
# Download Phils
echo && echo "Updates and Downloading Philss..."
echo
sleep 3
...
wget https://github.com/philscurrency/philscurrency/archive/master.zip
